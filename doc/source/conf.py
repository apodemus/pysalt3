...
# -*- coding: utf-8 -*-
#
# PySALT documentation build configuration file, created by
# sphinx-quickstart on Thu Sep 24 09:09:02 2009.
#
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.autosummary', 'sphinx.ext.doctest', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.pngmath']
...
version = pysalt.verno
# The full version, including alpha/beta/rc tags.
release = pysalt.verno
...
for task in tasks:
    ...
    package=temp[0]
    taskname=temp[2].strip('.hlp')

    if not os.path.exists(out+package):
        os.mkdir(out+package)
